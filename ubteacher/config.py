...
def add_ubteacher_config(cfg):
    ...
    _C.SEMISUPNET.CDPL_MAX_THRESHOLD_OFFSET = -1.0
    _C.SEMISUPNET.CDPL_START_ITER = -1
    _C.SEMISUPNET.CDPL_RAMP_ITERS = 0
    _C.SEMISUPNET.DEBUG_PSEUDO_STATS = False

    # dataloader
    # supervision level
    _C.DATALOADER.SUP_PERCENT = 100  # 5 = 5% dataset as labeled set
